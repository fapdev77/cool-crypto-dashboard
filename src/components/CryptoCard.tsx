  ...
  return (
    ...
    >
      <div className="flex justify-between items-start mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <span className="text-sm text-zinc-500 dark:text-zinc-400 font-medium">{symbol.replace('USDT', '')}</span>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 gap-4 pt-4 border-t border-zinc-100 dark:border-zinc-800/50">
        ...
        <div>
          <p className="text-xs text-zinc-500 dark:text-zinc-400 mb-1">Máx/Mín 24h</p>
